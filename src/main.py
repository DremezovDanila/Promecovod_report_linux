    ...
    while not finish_main_process:
        ...
        if cur_time_sec == 0:
            ...
            for site_params in sites_params:
                ...
                site_report_dir = f"{site_params[2]}/{site_params[0]}_{report_last_year}_{report_last_month:02}"
                ...
                if is_poll_ok:
                    ...
                    with open(f"{site_params[2]}/{site_params[0]}_{report_last_year}_{report_last_month:02}", "w", encoding="UTF-8") as site_report_file:
        ...
        if restore_report_start:
            ...
            if is_restore_report_site_exist and restore_report_input_data_ok:
                ...
                #  Get a directory for report text file of a site.
                site_report_dir = f"{restore_report_site_params[2]}/{restore_report_site_params[0]}_{restore_report_date_year}_{restore_report_date_month}"
                #  Initialise MBTCP connection.
                ...
                if site_mbtcp_client.last_error == 0:
                    ...
                    #  Write data into report text file.
                    with open(f"{restore_report_site_params[2]}/{restore_report_site_params[0]}_{restore_report_date_year}_{restore_report_date_month:02}",
                                "w",
                                encoding="UTF-8") as restore_report_file:
